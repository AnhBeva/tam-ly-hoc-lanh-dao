...
Repository dự kiến: https://github.com/AnhBeva/tam-ly-hoc-lanh-dao

Trang học tập dự kiến: https://anhbeva.github.io/tam-ly-hoc-lanh-dao/

Thiết lập GitHub Pages khuyến nghị:
...
Commit cả Markdown nguồn, `build_platform_html.py` và `index.html` để GitHub Pages luôn phục vụ bản mới nhất.
